...
def resort():
    ...
    pediaXML = ET.parse("E:\\mod\\MOAR_Units\\MoarUniqueUnits\\MoarUniqueUnits\\Text\\MoarUniqueUnits_LocalisationText_"+lang+".xml")
    ...
    locText[:] = [item[-1] for item in data]

    ET.ElementTree(gamedata).write("E:\\mod\\XML_Rewrite\\MoarUniqueUnits_LocalisationText_"+lang+".xml", encoding="utf-8")
